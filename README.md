...
```
### inside `~/.local/share/GSC Game World/S.T.A.L.K.E.R. - Call of Pripyat/_appdata_/` ⚠️
...
⚠️ Call of Chernobyl isn't working on linux, [issue](https://github.com/OpenXRay/xray-16/issues/1856) ⚠️
